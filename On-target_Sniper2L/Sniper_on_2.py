...
final_model = tf.keras.models.load_model('Sniper_on_2_pred_e079cbb4bbd24954e2cf064fdb50b253',compile=False)
...
X_test_feature = np.stack(dataset_all['feature'])
...
hyperparameter_prediction.columns=['target + PAM','feature','Prediction score']
